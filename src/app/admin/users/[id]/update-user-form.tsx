...
export default function UpdateUserForm({ user }: { user: z.infer<typeof updateUserSchema> }) {
  ...
  async function onSubmit(values: z.infer<typeof updateUserSchema>) {
    try {
      ...
      toast({ title: res.success ? 'User updated' : 'Unable to update user', variant: res.success ? 'default' : 'destructive', description: res.message });
      form.reset();
      router.push(`/admin/users`);
    } catch (error: any) {
      toast({ title: 'Unable to update user', variant: 'destructive', description: error.message });
    }
  }
