const Rating = ({ value, caption, responsive = false }: { value: number; caption?: string; responsive?: boolean }) => {
  const Full = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-auto ${responsive ? 'w-[0.8rem] sm:w-5' : 'w-5'} fill-current text-white`} viewBox="0 0 18 18">
